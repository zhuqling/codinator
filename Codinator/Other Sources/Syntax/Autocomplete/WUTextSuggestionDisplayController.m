...
//  Copyright (c) 2013 YuAo & (c) 2014 Vladi Danila. All rights reserved.
//
...
- (void)textSuggestionDisplayItemTapped:(WUTextSuggestionDisplayItem *)item {
   ...
   // NSString *PreR = NSStringFromRange(PreRange);
    ...
    [self performSelector:@selector(setBack) withObject:nil afterDelay:0.00001];
...
-(void)setBack{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"range" object:self userInfo:nil];
