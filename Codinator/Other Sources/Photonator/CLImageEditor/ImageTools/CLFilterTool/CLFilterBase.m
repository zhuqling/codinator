...
+ (NSDictionary*)defaultFilterInfo
{
    ...
    if(defaultFilterInfo==nil){
        ...
        @{
            ...
            @"CLDefaultGlassDistortion" : @{@"name":@"CIGlassDistortion",        @"title":NSLocalizedStringWithDefaultValue(@"vwasGlossy",                           nil, [CLImageEditorTheme bundle], @"Glass", @""),     @"version":@(9.0), @"dockedNum":@(14.0)},
...
+ (UIImage*)filteredImage:(UIImage*)image withFilterName:(NSString*)filterName
{
    ...
    else if ([filterName isEqualToString:@"CIGlassDistortion"]){
...
@interface CLDefaultGlassDistortion : CLDefaultEmptyFilter
@end
@implementation CLDefaultGlassDistortion
@end
