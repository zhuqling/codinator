...
{
    UISlider *slider = [[UISlider alloc] initWithFrame:CGRectMake(10, 0, 320, 30)];
    
    UIView *container = [[UIView alloc] initWithFrame:CGRectMake(0, 0, slider.width + 22, slider.height)];
    container.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.3];
    container.layer.cornerRadius = slider.height/2;
    
    slider.continuous = NO;
    [slider addTarget:self action:@selector(sliderDidChange:) forControlEvents:UIControlEventAllTouchEvents];
...
{
    _levelSlider = [self sliderWithValue:-4 minimumValue:-25 maximumValue:-2.0];
