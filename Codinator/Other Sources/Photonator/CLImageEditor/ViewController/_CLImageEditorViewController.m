...
- (void)initMenuScrollView
{
    ...
    visualEffectView.frame = CGRectMake(0, self.view.frame.size.height - self.menuView.frame.size.height, self.view.bounds.size.width, self.menuView.frame.size.height);
